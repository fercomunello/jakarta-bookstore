 ...
 *
 * <p>{@link io.github.bookstore.jakarta.view.Form} view implementations receives FORM data submits using
 * {@code application/x-www-form-urlencoded} format (RFC 1738). <br>
 *
 * <p>{@link io.github.bookstore.jakarta.view.DataTable} view implementations can iterate over a set of rows
 ...
 *
 * @see io.github.bookstore.jakarta.view.JakartaMvc
 */
